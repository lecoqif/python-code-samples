...
- `resize`: 15 passed.
- `dropna`: 18 passed.
- `groupby_nth`: 64 passed.
- `match_to_schema`: 25 passed.

Total: **133 passed**. Each sample was applied to a separate temporary copy of
its pinned installed package, with an assertion that imports came from that
